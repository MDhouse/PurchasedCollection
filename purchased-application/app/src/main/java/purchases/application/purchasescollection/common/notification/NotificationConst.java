...
public class NotificationConst {
    ...
    private static final String TITLE_NOTIFICATION = "Purchased";
    ...
    private static final String PURCHASED_TOAST = "purchases.application.purchasescollection.TOAST";
    private static final String PURCHASED_TOAST_MESSAGE = "purchases.application.purchasescollection.TOAST_MESSAGE";
    ...
    public static String getPurchasedToast() {
        return PURCHASED_TOAST;
    }

    public static String getPurchasedToastMessage() {
        return PURCHASED_TOAST_MESSAGE;
    }
}
